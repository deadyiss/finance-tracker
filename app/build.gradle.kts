...
android {
    namespace = "com.prosperity.tracker"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.prosperity.tracker"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        release {
            // No code shrinking, so the unsigned/debug APK is straightforward to build and install.
